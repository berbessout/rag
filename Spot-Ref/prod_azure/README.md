# 🚀 Spot-Ref Azure Container Apps Production Deployment

This folder contains all the necessary files and scripts for deploying Spot-Ref to Azure Container Apps in production.
...
├── DEPLOYMENT-SUMMARY.md              # Complete technical summary
└── scripts/
...
```powershell
# Navigate to the prod_azure folder
cd prod_azure
...
```powershell
# Build new version
.\scripts\build-and-push.ps1 -ContainerRegistryName "spotrefacr" -ImageTag "v1.1.0"
...
3. **Run deployment**: `.\scripts\quick-deploy.ps1 [parameters]`
4. **Run ingestion**: `.\scripts\run-ingestion.ps1 -ResourceGroupName "spot-ref-prod"`
5. **Access application**: Visit the provided Chainlit URL

Your Spot-Ref application will be production-ready on Azure Container Apps! 🎉 